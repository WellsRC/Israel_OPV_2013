...
for kk=1:1
    fnum=1;
    while exist(['721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'], 'file')
           fnum=fnum+1;
    end
    f1=fopen(['721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'],'w');
    f2=fopen(['Kappa-721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'],'w');
    f3=fopen(['ProStrat-721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'],'w');
    f4=fopen(['IndStrat-721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'],'w');
    f5=fopen(['UnawareStrat-721VacCoverage-HeterogeneousRisk-MinKappa-ProsocialAware-rho=' num2str(rho) '-pc=' num2str(kk) '-' num2str(fnum) '.txt'],'w');
